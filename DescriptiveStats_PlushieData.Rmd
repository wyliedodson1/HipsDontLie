...
range.pelv
# Answer: 1
range.midthighcircum <- max(plush.dat$MidthighCircumference) - min(plush.dat$MidthighCircumference)
range.midthighcircum
# Answer: 0.5
range.thighlen <- max(plush.dat$ThighLength) - min(plush.dat$ThighLength)
range.thighlen
# Answer: 2.5
range.kneedistance <- max(plush.dat$DistanceBetweenKnees) - min(plush.dat$DistanceBetweenKnees)
range.kneedistance
# Answer: 7
